        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link href="#services" className={activeLink === 'services' ? 'active navbar-link': 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}>SERVICIOS</Nav.Link>
            ...
            <span className="navbar-text">
                ...
                <button className='vvd' onClick={() => console.log('connect')}><span>Contactar</span></button>
            </span>
          </Navbar.Collapse>
        </Container>
      </Navbar>
